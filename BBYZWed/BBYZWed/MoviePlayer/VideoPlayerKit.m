...
NSString * const kVideoPlayerSplashVideoEndNotification = @"VideoPlayerSplashVideoEndNotification";
...
- (void)playerItemDidReachEnd:(NSNotification *)notification
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"VideoPlayerSplashVideoEndNotification"
                                                        object:self
                                                      userInfo:nil];
    [self minimizeVideo];
}
